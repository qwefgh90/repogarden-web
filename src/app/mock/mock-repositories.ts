...
const commit1: Commit = new Commit("aasdvf23cv", "first commit", "20170505", "qwefgh90", "leadersama", "url", [cve1]);

const commit2: Commit = new Commit("7ukm7j6km", "second commit", "20170505", "qwefgh90", "leadersama", "url", [cve2, cve3]);
